...
export default function DashboardHeader() {
  ...
  return (
    <header className="fixed top-14 md:top-0 left-0 right-0 z-40 h-16 px-6 flex items-center justify-between bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 md:ml-64">
      <NavigationControls />
