...
const AvatarIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" width="200" height="200" className={className}>
        <mask id="cs_mask_1_flower-1" className="svg-mask-alpha" width="200" height="186" x="0" y="7" maskUnits="userSpaceOnUse" />
        <mask id="cs_mask_1_flower-1" className={styles.maskAlpha} width="200" height="186" x="0" y="7" maskUnits="userSpaceOnUse">
        ...
        <g className="mix-blend-overlay" mask="url(#cs_mask_1_flower-1)">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-10">
            ...
            <a href="/" className="flex items-center gap-2 flex-shrink-0">
               <MountainIcon className="h-6 w-6 text-blue-700 dark:text-blue-300" />
              <span className="text-lg font-extrabold tracking-tight text-blue-700 dark:text-blue-200">FormHook</span>
            </a>
             ...
             <div className="relative hidden sm:block" ref={notificationsDropdownRef}>
                ...
                <div className={`absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg transition-opacity duration-300 ${isNotificationsOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 max-h-60 overflow-y-auto">
                        {/* TODO: Replace with dynamic notifications from webhooks/submissions */}
