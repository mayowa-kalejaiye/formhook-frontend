      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-3">
            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Step {step} of 2</span>
            <span className="text-sm text-gray-500 dark:text-gray-400">{Math.round((step / 2) * 100)}%</span>
          </div>
        ...
        <div className="signin-card bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div className="text-red-600 text-center font-medium bg-red-50 rounded p-2 border border-red-100 mb-2">{error}</div>
            )}
            {success && (
              <div className="text-green-600 text-center font-medium bg-green-50 rounded p-2 border border-green-100 mb-2">
                ...
                <div className="space-y-2">
                  ...
                  {password && (
                    <div className="mt-2 space-y-2">
                      ...
                      <div className="flex justify-between items-center text-xs">
                        ...
                        {passwordErrors.length === 0 ? (
                          <span className="text-green-600 dark:text-green-400 flex items-center">
                            <span className="mr-1"><CheckIcon /></span> Valid
                          </span>
                        ) : (
                          <span className="text-gray-500 dark:text-gray-400">
                            {passwordErrors.length} issue{passwordErrors.length !== 1 ? 's' : ''}
                          </span>
                        )}
                      </div>
                      ...
                      {passwordErrors.length > 0 && (
                        <ul className="text-xs text-red-600 dark:text-red-400 pl-5 space-y-1 list-disc">
